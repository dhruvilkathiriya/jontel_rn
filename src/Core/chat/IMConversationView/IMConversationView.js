  ...
  return (
    <TouchableOpacity
      ...
      <View style={styles.chatItemContent}>
        <Text style={[styles.chatFriendName, { fontFamily: AppStyles.fontName.main }]}>{title || 'Loading...'}</Text>
        <View style={styles.content}>
          <Text
            numberOfLines={1}
            ellipsizeMode={'middle'}
            style={[styles.message, { fontFamily: AppStyles.fontName.main, color: '#333' }]}>
            {formatMessage(item)} {' · '}
