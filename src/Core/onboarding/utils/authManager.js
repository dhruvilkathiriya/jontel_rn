...
const defaultProfilePhotoURL = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png";
        ...
        firebaseAuth
            ...
            .then(response => {
                ...
                if (response.error) {
                    ...
                    handleSuccessfulLogin(response.user, false)
                        .then(response => {
                            //console.log("handleSuccessfulLogin:", response)
                            resolve(response)
                        })
                }
            })
