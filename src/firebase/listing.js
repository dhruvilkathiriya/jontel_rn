...
export const postListing = (
  ...
  if (selectedItem) {
    //isApproved: true, completedReg: true  this is for auto approve when provider alredy approved
    listingsRef
      .doc(selectedItem.id)
      .update({ ...updatedUploadObjects, photo: coverPhoto, isApproved: true, completedReg: true })
      .then(docRef => {
        callback({ success: true });
      })
      .catch(error => {
